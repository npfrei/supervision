...
.reel[data-era='nouvelle-vague'] { background: linear-gradient(180deg, #07090a 0%, #0c1520 60%, #0e1a2a 100%); }
.reel[data-era='political']      { background: linear-gradient(180deg, #0a0707 0%, #1a0c10 55%, #0f0810 100%); }
.reel[data-era='commercial']     { background: linear-gradient(180deg, #080a07 0%, #111a0c 55%, #0a0f08 100%); }
.reel[data-era='later']          { background: linear-gradient(180deg, #07070a 0%, #101018 55%, #0a0a10 100%); }
...
.rule { height: 1px; width: 40px; background: rgba(58,130,224,0.7); }
.eyebrow {
...
.quote {
  ...
  line-height: 1.4;
  color: rgba(216,228,232,0.75);
  margin: 0 0 20px;
  padding-left: 18px;
  border-left: 2px solid rgba(58,130,224,0.4);
}
.attribution {
  display: block;
  font-size: 12px;
...
.poster {
  ...
  background: rgba(216,228,232,0.06);
  border-radius: 3px;
  overflow: hidden;
  margin-bottom: 6px;
}
...
.troupe-link:hover {
  color: #3a82e0;
  border-bottom-color: rgba(58,130,224,0.5);
}
.troupe-list li.faint .troupe-link { color: rgba(216,228,232,0.55); }
.troupe-list li.faint .troupe-link:hover { color: #3a82e0; }
...
.theme-chip {
  ...
  font-size: 11px;
  padding: 5px 11px;
  border: 1px solid rgba(58,130,224,0.35);
  border-radius: 999px;
  color: rgba(216,228,232,0.85);
}
