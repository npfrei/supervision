<template>
  <section ref="root" class="cover">
    ...
    <div class="content">
      ...
      <h1 class="title">
        Derek Jarman<br>
        <em>Queer Perspectives and Activism</em>
      </h1>
...
.cover {
  ...
  padding: 60px 60px;
  background:
    radial-gradient(ellipse at 50% 30%, #0c1a2a 0%, #0d1114 45%, #07090a 100%);
  color: #d8e4e8;
  overflow: hidden;
}
...
.back-btn:hover { color: rgba(216,228,232,0.95); }
...
.rule { height: 1px; width: 50px; background: rgba(58,130,224,0.7); }
.eyebrow {
  font-family: var(--font-sans);
  font-size: 11px;
