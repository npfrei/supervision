...
.cover {
  ...
  padding: 60px 60px;
  background:
    radial-gradient(ellipse at 50% 30%, #0a1410 0%, #0c1210 45%, #070a08 100%);
  color: #c8d8c0;
  overflow: hidden;
}
...
.back-btn:hover { color: rgba(200,216,192,0.95); }
...
.rule { height: 1px; width: 50px; background: rgba(100,180,120,0.7); }
.eyebrow {
  font-family: var(--font-sans);
  font-size: 11px;
