...
const ERAS: EraDef[] = [
  ...
  },
  {
    ...
    lede: 'Herzog’s documentary is primarly defined by a voiceover narration, always through Herzog’s own voice, which expresses the filmmaker’s personal meditation and point of view on the film’s images. Most of them, while usually being about "remarkable" people, do not focus on their actions but reflect on their inner-workings and sufferings. He shows how a community of deaf and blind people live in a world they cannot perceive in Land of Silence and Darkness. In Woodcarver Steiner, he shows the frustrations of a Ski Jumper, who only wishes to feel the ecstasy of flying, with a competive environment that constantly endangers his safety. Grizzly Man depicts the delusions of man eaten by the bears he tought he had befriended. God’s Angry Man and Huie’s Sermon explore the language and communication used by religious leaders.',
    themes: [],
    insight: '',
    audioTrack: 'era3.mp3',
    audioLabel: '',
