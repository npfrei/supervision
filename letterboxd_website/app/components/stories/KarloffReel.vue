...
.reel[data-era='early-career'] { background: linear-gradient(180deg, #07090a 0%, #0c1410 60%, #0a1810 100%); }
.reel[data-era='stardom']      { background: linear-gradient(180deg, #070a07 0%, #101a0c 55%, #141e0c 100%); }
.reel[data-era='rivalry']      { background: linear-gradient(180deg, #090708 0%, #180c14 55%, #1a0c10 100%); }
.reel[data-era='later-works']  { background: linear-gradient(180deg, #07080a 0%, #0c1018 55%, #0a0e1a 100%); }
...
.rule { height: 1px; width: 40px; background: rgba(100,180,120,0.7); }
.eyebrow {
...
.quote {
  ...
  line-height: 1.4;
  color: rgba(200,216,192,0.75);
  margin: 0 0 20px;
  padding-left: 18px;
  border-left: 2px solid rgba(100,180,120,0.4);
}
.attribution {
  display: block;
  font-size: 12px;
...
.poster {
  ...
  background: rgba(200,216,192,0.06);
  border-radius: 3px;
  overflow: hidden;
  margin-bottom: 6px;
}
...
.troupe-link:hover {
  color: #64b478;
  border-bottom-color: rgba(100,180,120,0.5);
}
.troupe-list li.faint .troupe-link { color: rgba(200,216,192,0.55); }
.troupe-list li.faint .troupe-link:hover { color: #64b478; }
