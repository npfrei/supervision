...
.reel[data-era='identity']       { background: linear-gradient(180deg, #09070a 0%, #1a0e12 60%, #200e14 100%); }
.reel[data-era='autobiographies'] { background: linear-gradient(180deg, #0a0807 0%, #1a120a 55%, #1e1208 100%); }
.reel[data-era='cities']         { background: linear-gradient(180deg, #07090a 0%, #0e1018 55%, #0a0e1a 100%); }
...
.rule { height: 1px; width: 40px; background: rgba(200,130,100,0.7); }
.eyebrow {
...
.quote {
  ...
  margin: 0 0 20px;
  padding-left: 18px;
  border-left: 2px solid rgba(200,130,100,0.4);
}
.attribution {
  display: block;
  font-size: 12px;
...
.poster {
  ...
  background: rgba(232,216,204,0.06);
  border-radius: 3px;
  overflow: hidden;
  margin-bottom: 6px;
}
...
.troupe-link:hover {
  color: #c88264;
  border-bottom-color: rgba(200,130,100,0.5);
}
.troupe-list li.faint .troupe-link { color: rgba(232,216,204,0.55); }
.troupe-list li.faint .troupe-link:hover { color: #c88264; }
