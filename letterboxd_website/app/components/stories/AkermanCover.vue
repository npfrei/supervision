...
.cover {
  ...
  padding: 60px 60px;
  background:
    radial-gradient(ellipse at 50% 30%, #1a0f0a 0%, #140e10 45%, #09070a 100%);
  color: #e8d8cc;
  overflow: hidden;
}
...
.back-btn:hover { color: rgba(232,216,204,0.95); }
...
.rule { height: 1px; width: 50px; background: rgba(200,130,100,0.7); }
.eyebrow {
  font-family: var(--font-sans);
  font-size: 11px;
